...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            numerical_cols = ['Delivery_person_Age_imputed', 'Delivery_person_Ratings_imputed','Vehicle_condition','distance','multiple_deliveries',]
    ...
    def initaite_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info('claculating distance completed')
            logging.info(f'Train Dataframe Head : \n{train_df.head().to_string()}')
            logging.info(f'Test Dataframe Head  : \n{test_df.head().to_string()}')
             

            logging.info('start handling missing data intiated')
            ...
            test_df['Delivery_person_Ratings_imputed'][test_df['Delivery_person_Ratings_imputed'].isnull()] = test_df['Delivery_person_Ratings'].dropna().sample(df['Delivery_person_Ratings'].isnull().sum()).values

            train_df = train_df.dropna()
            test_df  = test_df.dropna()

            logging.info('handing missing data succesfull')
            ...
            drop_columns = [target_column_name,'ID','Delivery_person_ID','Delivery_person_Age','Delivery_person_Ratings','Restaurant_latitude','Restaurant_longitude','Delivery_location_latitude','Delivery_location_longitude','Order_Date','Time_Orderd','Time_Order_picked','Type_of_order']
